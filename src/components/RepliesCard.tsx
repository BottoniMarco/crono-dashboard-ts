...
type RepliesCardProps = {
  count: number
  // use emoji or initials for quick placeholders; you can swap for images later
  avatars?: string[]
}
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <rect
        ...
        strokeWidth={1.8}
      />
      {/* inner line to suggest mail flap */}
      <path
        d="M3 10h18"
        stroke="currentColor"
        strokeWidth={1.8}
      />
      {/* arrow down inside the tray */}
      <path
      ...
      >
        ...
        <div className="flex items-center">
          {avatars.slice(0, 5).map((a, i) => (
            ...
            >
              {/* if you later switch to images, place an <img> here and keep ring/rounded */}
